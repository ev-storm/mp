...
useHead({
  ...
  meta: [
    {
      name: "description",
      content: "Широкоформатное сканирование",
    },
  ],
});
...
const submitOrder = () => {
  ...
  const orderData = {
    productType: "Широкоформатное сканирование",
    printType: "Широкоформатное сканирование",
        ...
        <div class="tab-main">
          <div class="tab-option">
            <div class="tab-option-img">
              <img src="/public/img/large/2.png" alt="" />
            </div>
          ...
          <TabOrder
            ...
            title="Широкоформатное сканирование"
            subTitle="Наша компания специализируется на широкоформатной печати на современном, новом оборудовании HP Designjet Z3200, что позволяет осуществлять цветную  и ч/б широкоформатную печать с разрешением 2400x1200 DPI до формата А0+ включительно.<br><br>
						Оптическое разрешение 300 dpi при широкоформатном сканировании является оптимальным и, как правило, достаточным для решения любых практических задач. Исключение составляют случаи наличия мелких деталей изображения (тонких линий) на сканируемых оригиналах или, например, сканирование высококачественных фотографий."
            :fields="fields"
