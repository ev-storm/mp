...
// Конфигурация полей из единого файла конфигурации + серверные данные
const pageKey: PageConfigKey = "visit-card-laser";
const {
  fields,
  productionDays,
  pageImage,
        ...
        <div class="tab-main">
          <div class="tab-option">
            <div class="tab-option-img">
              <img :src="pageImage || '/img/visit/1.png'" alt="Изображение" />
            </div>
