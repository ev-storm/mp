...
const submitOrder = async () => {
  await submitOrderFn({
    productType: "Ламинирование документов",
    fields,
        ...
        <div class="tab-main">
          <div class="tab-option">
            <div class="tab-option-img">
              <img :src="pageImage || '/img/lam/1.png'" alt="Изображение" />
            </div>
