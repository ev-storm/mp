...
const submitOrder = async () => {
  await submitOrderFn({
    productType: "Широкоформатное ламинирование",
    fields,
        ...
        <div class="tab-main">
          <div class="tab-option">
            <div class="tab-option-img">
              <img :src="pageImage || '/img/lam/2.png'" alt="Изображение" />
            </div>
