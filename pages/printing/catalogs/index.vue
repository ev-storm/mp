...
const defaultImage = "/img/catalogs/1.png";
        ...
        <div class="tab-main">
          <div class="tab-option">
            <div class="tab-option-img">
              <img :src="pageImage || '/img/catalogs/1.png'" alt="Изображение" />
            </div>
          ...
          <TabOrder
            title="Брошюры и каталоги <br> <span  style='font-size:15px;'>лазерная печать</span>"
