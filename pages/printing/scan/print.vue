...
useHead({
  ...
  meta: [
    {
      name: "description",
      content: "Печать документа",
    },
  ],
});

// Конфигурация полей из единого файла конфигурации
const pageKey: PageConfigKey = "scan-print";
...
const defaultImage = "/img/scan/2.png";
...
const submitOrder = async () => {
  await submitOrderFn({
    productType: "Печать и копирование до А3",
    printType: undefined,
    fields,
      ...
      <div class="tab-con">
        <div class="tab-btn-con">
          <NuxtLink
            ...
            class="tab-btn"
            :class="{
              active: $route.path === '/printing/scan/print',
            }"
          >
            Печать документа
          </NuxtLink>
          <NuxtLink
            ...
            class="tab-btn"
            :class="{
              active: $route.path === '/printing/scan',
            }"
          >
        ...
        <div class="tab-main">
          <div class="tab-option">
            <div class="tab-option-img">
              <img :src="pageImage || '/img/scan/2.png'" alt="Изображение" />
            </div>
