...
useHead({
  title: "Тестовая страница издательства",
  meta: [
    {
      name: "description",
      content: "Тестовая страница для издательства",
    },
  ],
});

// Конфигурация полей из единого файла конфигурации - ВАЖНО: используем правильный ключ!
const pageKey: PageConfigKey = "publish-test";
...
onMounted(() => {
  ...
  window.addEventListener("storage", updateProductionDays);
...
const submitOrder = async () => {
  await submitOrderFn({
    productType: "Тестовая страница издательства",
    printType: undefined,
    fields,
